$(document).ready(function(){
    ...
    $("#b_1").click(function(){
        ...
        $("#content_box").css("background-position", "200% 500%");
    ...
    $("#b_2").click(function(){
     ...
     $("#b_3").click(function(){
         $("#content_box").hide().fadeIn('slow');
         $("#content_box").css("background-image","url('../img/honey.png')");
        $("#content_box").css("background-position", "100% 70%");
       $("#inner_box").css("background-color","yellow");
       $("#inner_box").html("<h1>Honey.js</h1><p>My first story based JavaScript game. I created this game using nothing but jQuery, CSS, and HTML. I also came up with all of the original content and illustrations.</p><a href='http://josuearce.com/honey' target='_blank'><button>Play the game</button></a>");
    ...
    $("#b_4").click(function(){
       ...
       $("#content_box").css("background-position", "120% 70%");
